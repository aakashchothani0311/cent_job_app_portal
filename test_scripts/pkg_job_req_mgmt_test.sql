...
BEGIN
    ...
    JOB_REQ_MGMT.UPDATE_REQ_STATUS(2342, 'TEST TITLE', 'TEST DESC');
    
    DBMS_OUTPUT.PUT_LINE('3. Testing for invalid TITLE by passing an empty value:');
    JOB_REQ_MGMT.UPDATE_REQ_STATUS(C_VALID_REQ_ID, '');
    
    DBMS_OUTPUT.PUT_LINE('4. Testing for invalid DESCRIPTION by passing an empty value:');
    JOB_REQ_MGMT.UPDATE_REQ_STATUS(C_VALID_REQ_ID, 'TEST TITLE', NULL);
    
    DBMS_OUTPUT.PUT_LINE('5. Testing for invalid STATUS by passing an empty value:');
    JOB_REQ_MGMT.UPDATE_REQ_STATUS(C_VALID_REQ_ID, 'TEST TITLE', 'TEST DESCRIPTION', 0, '');
    ...
    JOB_REQ_MGMT.UPDATE_REQ_STATUS(C_VALID_REQ_ID, 'TEST TITLE', 'TEST DESCRIPTION', 0, 'rejected');
    
    DBMS_OUTPUT.PUT_LINE('7. Testing for valid TITLE update:');
    JOB_REQ_MGMT.UPDATE_REQ_STATUS(C_VALID_REQ_ID, 'TITLE UPDATED');
