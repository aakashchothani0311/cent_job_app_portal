...
BEGIN
    ...
    EXECUTE IMMEDIATE 'CREATE TABLE JOB_REQUISITION (
        ...
        RELOCATION_ALLOWANCE NUMBER(1) DEFAULT 0 CHECK(RELOCATION_ALLOWANCE IN (0,1)),
        ...
        CONSTRAINT CHK_APP_DEADLINE_AFTER_POSTING CHECK (APPLICATION_DEADLINE > DATE_POSTED AND )
    )';
...
BEGIN
    ...
    EXECUTE IMMEDIATE 'CREATE TABLE CANDIDATE_APPLICATION (
        ...
        CONSTRAINT CHK_CAN_APP_STATUS CHECK (STATUS IN (''draft'', ''candidate rejected'', ''in review'', ''offer accepted'', ''offer rejected'', 
