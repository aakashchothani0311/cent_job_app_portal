...
BEGIN
    ...
    EXECUTE IMMEDIATE 'CREATE VIEW JOBS_APPLIED_HISTORY
    AS 
    SELECT
...
BEGIN
    ...
    EXECUTE IMMEDIATE 'CREATE VIEW JOBS_CREATED_HISTORY 
    AS
    SELECT
        JR.RECRUITER_ID,
...
BEGIN
    ...
    EXECUTE IMMEDIATE 'CREATE VIEW CANDIDATES_JOBS_APPLIED
    AS
    SELECT
        JR.REQ_ID,
        JR.JOB_TITLE,
...
BEGIN
    ...
    EXECUTE IMMEDIATE 'CREATE VIEW OPEN_JOBS
    AS
    SELECT
...
BEGIN
    ...
    EXECUTE IMMEDIATE 'CREATE VIEW CANDIDATE_PROFILE
    AS
    SELECT
        C.CANDIDATE_ID,
        U.FIRSTNAME || '' '' || U.LASTNAME AS CANDIDATE_NAME,
