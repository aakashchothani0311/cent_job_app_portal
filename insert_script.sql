...
(2, 'Web Innovators', 'Frontend Developer', TO_TIMESTAMP('2018-03-15', 'YYYY-MM-DD'), TO_TIMESTAMP('2021-09-30', 'YYYY-MM-DD'), 'Created responsive web designs.'),
(3, 'FinServe Inc.', 'Data Analyst', TO_TIMESTAMP('2020-01-01', 'YYYY-MM-DD'), TO_TIMESTAMP('2023-01-01', 'YYYY-MM-DD'), 'Analyzed financial data.'),
...
(7, 'AutoWorks', 'Quality Engineer', TO_TIMESTAMP('2018-11-05', 'YYYY-MM-DD'), NULL, 'Ensured product quality.'),
(6, 'SmartTech', 'System Administrator', TO_TIMESTAMP('2019-05-10', 'YYYY-MM-DD'), NULL, 'Managed IT infrastructure.'),
(2, 'HealthWorks', 'Project Coordinator', TO_TIMESTAMP('2016-01-15', 'YYYY-MM-DD'), TO_TIMESTAMP('2019-06-30', 'YYYY-MM-DD'), 'Coordinated health projects and resources.'),
(4, 'EcoEnergy', 'Environmental Consultant', TO_TIMESTAMP('2017-08-01', 'YYYY-MM-DD'), TO_TIMESTAMP('2021-07-31', 'YYYY-MM-DD'), 'Advised on environmental impact and sustainability.'),
...
(5, 'Urban Planning Co.', 'Urban Planner', TO_TIMESTAMP('1995-04-10', 'YYYY-MM-DD'), TO_TIMESTAMP('2022-08-01', 'YYYY-MM-DD'), 'Designed urban planning projects.'),
(3, 'DataCorp', 'Database Administrator', TO_TIMESTAMP('2019-09-15', 'YYYY-MM-DD'), TO_TIMESTAMP('2022-06-01', 'YYYY-MM-DD'), 'Managed and optimized database systems.'),
(1, 'TechVerse', 'IT Support Specialist', TO_TIMESTAMP('2021-02-01', 'YYYY-MM-DD'), NULL, 'Provided technical support and troubleshooting.');
...
(6, 'University of Texas', 'BA', 'Accounting', TO_DATE('2014-09-01', 'YYYY-MM-DD'), NULL, 0),
...
(7, 'University of Chicago', 'MSc', 'Biology', TO_DATE('2018-09-01', 'YYYY-MM-DD'), NULL, 0);
...
(2, 2, 'Data Scientist', 'Analyze data and build predictive models.', TO_DATE('2024-03-01', 'YYYY-MM-DD'), TO_DATE('2024-04-01', 'YYYY-MM-DD'), 1, 'open'),
...
(5, 5, 'Data Analyst', 'Interpret data to improve decision-making.', TO_DATE('2024-03-15', 'YYYY-MM-DD'), TO_DATE('2024-04-10', 'YYYY-MM-DD'), 0, 'open'),
(6, 6, 'Accountant', 'Manage financial records and budgeting.', TO_DATE('2024-03-25', 'YYYY-MM-DD'), TO_DATE('2024-05-05', 'YYYY-MM-DD'), 0, 'open'),
(7, 7, 'Retail Manager', 'Oversee retail operations.', TO_DATE('2024-02-28', 'YYYY-MM-DD'), TO_DATE('2024-03-20', 'YYYY-MM-DD'), 1, 'open'),
(8, 8, 'Construction Engineer', 'Manage construction projects.', TO_DATE('2024-04-01', 'YYYY-MM-DD'), TO_DATE('2024-05-10', 'YYYY-MM-DD'), 1, 'open'),
(9, 9, 'Network Administrator', 'Manage and secure network infrastructure.', TO_DATE('2024-03-20', 'YYYY-MM-DD'), TO_DATE('2024-05-01', 'YYYY-MM-DD'), 1, 'open'),
(10, 10, 'Research Scientist', 'Conduct scientific research and analysis.', TO_DATE('2024-03-30', 'YYYY-MM-DD'), TO_DATE('2024-05-15', 'YYYY-MM-DD'), 0, 'open');
