...
BEGIN
    ...
    EXECUTE IMMEDIATE 'GRANT SELECT ON CANDIDATE_PROFILE TO CANDIDATE';
...
BEGIN
    ...
    EXECUTE IMMEDIATE 'GRANT SELECT ON JOBS_APPLIED_HISTORY TO RECRUITER';
    EXECUTE IMMEDIATE 'GRANT SELECT ON JOBS_OPEN TO RECRUITER';
    EXECUTE IMMEDIATE 'GRANT SELECT ON CANDIDATE_PROFILE TO RECRUITER';
