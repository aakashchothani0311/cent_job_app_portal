...
BEGIN
    ...
    --Added by Mayur for Packages execution privileges
    EXECUTE IMMEDIATE 'GRANT EXECUTE ON ADMIN_SUPER_USER.PKG_CANDIDATE_USER_MANAGEMENT TO CANDIDATE';
    EXECUTE IMMEDIATE 'GRANT SELECT, INSERT, UPDATE ON ADMIN_SUPER_USER.USERS TO CANDIDATE';
    EXECUTE IMMEDIATE 'GRANT SELECT, INSERT, UPDATE ON ADMIN_SUPER_USER.ADDRESS TO CANDIDATE';
    EXECUTE IMMEDIATE 'GRANT SELECT, INSERT, UPDATE ON ADMIN_SUPER_USER.CANDIDATES TO CANDIDATE';
