...
BEGIN
    ...
    -- Acccess to views
    EXECUTE IMMEDIATE 'GRANT SELECT, UPDATE ON JOBS_APPLIED_HISTORY TO CANDIDATE';
...
BEGIN
    ...
    -- Acccess to views
    EXECUTE IMMEDIATE 'GRANT SELECT, UPDATE ON JOBS_APPLIED_HISTORY TO RECRUITER';
    EXECUTE IMMEDIATE 'GRANT SELECT ON JOBS_OPEN TO RECRUITER';
    EXECUTE IMMEDIATE 'GRANT SELECT, UPDATE ON CANDIDATE_PROFILE TO RECRUITER';
