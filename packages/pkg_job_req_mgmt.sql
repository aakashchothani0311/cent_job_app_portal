...
CREATE OR REPLACE PACKAGE BODY PKG_JOB_REQ_MGMT AS
    ...
    EXCEPTION
        ...
        WHEN NULL_REC_ID_EXEC THEN
            UTIL_PKG.ADD_NEW_LINE(UTIL_PKG.ADD_TAB('Error updating JOB_REQUISITION: REC_ID is needed to validate record access.'));
...
CREATE OR REPLACE PUBLIC SYNONYM JOB_REQ_MGMT
